...
source DART_params_generatespread.csh
#=========================================================================
...
# Move the generated files to the sub direcotry spin_*
   ...
   while ($inst <= $num_instances)
      ...
      ${LINK} ${spin_dir}/${CASE}.clm2${inst_string}.r.2020-01-01-00000.nc   .
      @ inst ++
   end
# Replace the initialization file and set CONTINUE_RUN=FALSE
   ...
   if ( ${spin_num} == 1 ) then
      ...
      while ($inst <= $num_instances)
         ...
         sed s/inidata_file/${CASE}.clm2${inst_string}.r.2020-01-01-00000.nc/g user_nl_clm_temp >! ${fname}
         @ inst ++
      end
   endif
