...
!               aquad = params_inst%theta_psii
!qabs  = 0.132 * par_z_sun(p,iv) * 4.6_r8 ! 5oC observed mean in Rogers et al (2019)
!aquad = 0.44 ! 5oC observed mean in Rogers et al (2019)
!qabs  = 0.037 * par_z_sun(p,iv) * 4.6_r8 ! wrongly calculated quantum yield of CO2 fixation at 15oC observed mean in Rogers et al (2019)
!qabs  = 0.217 * par_z_sun(p,iv) * 4.6_r8 ! right calculated quantum yield of CO2 fixation at 15oC observed mean in Rogers et al (2019)
!aquad = 0.5 ! 0.5 convexity factor or curature at 15oC observed mean in Rogers et al (2019)
!qabs  = 0.045 * par_z_sun(p,iv) * 4.6_r8 ! wrongly calculated at 25oC observed mean in Rogers et al (2019)
!qabs  = 0.316 * par_z_sun(p,iv) * 4.6_r8 ! right calculated at 25oC observed mean in Rogers et al (2019)
!aquad = 0.65 ! 0.65 at 25oC observed mean in Rogers et al (2019)
!qabs  = 0.06 * par_z_sun(p,iv) * 4.6_r8 ! Sensitivity Analysis
!aquad = 0.8 ! Sensitivity Analysis
if (278.15 <= t_veg(p) .and. t_veg(p) <= 298.15) then
qabs  = (0.083833 + 0.0092 * (t_veg(p)-tfrz)) * par_z_sun(p,iv) * 4.6_r8 ! leaf temperature response of quantum yield derived from Rogers et al (2019)
aquad = 0.0004 * (t_veg(p)-tfrz)**2 - 0.003 * (t_veg(p)-tfrz) + 0.4437 ! leaf temperature response of curvature derived from Rogers et al (2019)
else if (t_veg(p) < 278.15) then
qabs  = 0.132 * par_z_sun(p,iv) * 4.6_r8 ! 5oC observed mean in Rogers et al (2019)
aquad = 0.44 ! 5oC observed mean in Rogers et al (2019)
else
qabs  = 0.316 * par_z_sun(p,iv) * 4.6_r8 ! right calculated at 25oC observed mean in Rogers et al (2019)
...
!               aquad = params_inst%theta_psii
!qabs  = 0.132 * par_z_sha(p,iv) * 4.6_r8 ! quantum yield at 5oC observed mean in Rogers et al (2019)
!aquad = 0.44 ! curature at 5oC observed mean in Rogers et al (2019)
!qabs  = 0.037 * par_z_sha(p,iv) * 4.6_r8 ! wrongly calculated quantum yield of CO2 fixation at 15oC observed mean in Rogers et al (2019)
!qabs  = 0.217 * par_z_sha(p,iv) * 4.6_r8 ! right calculated quantum yield of CO2 fixation at 15oC observed mean in Rogers et al (2019)
!aquad = 0.5 ! 0.5 convexity factor or curature at 15oC observed mean in Rogers et al (2019)
!qabs  = 0.045 * par_z_sha(p,iv) * 4.6_r8 ! wrongly calculated at 25oC observed mean in Rogers et al (2019)
!qabs  = 0.316 * par_z_sha(p,iv) * 4.6_r8 ! right calculated at 25oC observed mean in Rogers et al (2019)
!aquad = 0.65 ! 0.65 at 25oC observed mean in Rogers et al (2019)
!qabs  = 0.06 * par_z_sha(p,iv) * 4.6_r8 ! Sensitivity Analysis
!aquad = 0.8 ! Sensitivity Analysis
if (278.15 <= t_veg(p) .and. t_veg(p) <= 298.15) then
qabs  = (0.083833 + 0.0092 * (t_veg(p)-tfrz)) * par_z_sha(p,iv) * 4.6_r8 ! leaf temperature response of quantum yield derived from Rogers et al (2019)
aquad = 0.0004 * (t_veg(p)-tfrz)**2 - 0.003 * (t_veg(p)-tfrz) + 0.4437 ! leaf temperature response of curvature derived from Rogers et al (2019)
else if (t_veg(p) < 278.15) then
qabs  = 0.132 * par_z_sha(p,iv) * 4.6_r8 ! quantum yield at 5oC observed mean in Rogers et al (2019)
aquad = 0.44 ! curature at 5oC observed mean in Rogers et al (2019)
